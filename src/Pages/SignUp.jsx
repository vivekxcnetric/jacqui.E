...
const SignUp = () => {
  ...
  const handleBlurPassword = () => {
    if (!password) {
      ...
      setPasswordErrorMessage(
        "The password must contain at least one digit and be at least 6 characters long."
      );
    } else {
      setPasswordErrorMessage("");
    }
  ...
  return (
    <Container>
      <CenteredText>
        <h4>MORE BRANDS TO SHOP ONE ACCOUNT.</h4>
      </CenteredText>
      <CenteredText>
        <div
          style={{
      ...
      <div style={{ textAlign: "center", margin: "20px" }}>
        ...
        <p>
          Plus, sign up to our emails to be the first to know about our new
          collections & latest offers.
        </p>
      </div>
      <FormContainer>
        <FormWrapper>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "10px", display: "flex", gap: "10px" }}>
              ...
              <div>
                <label htmlFor="terms">
                  Sign up to JacquiE emails and receive 15% off your next full
                  price purchase at JacquiE.
                </label>
              </div>
            </div>
        ...
        <ImageWrapper>
          <img src="https://jacquie.jgl.com.au/EJ/aurora/images/espot/static/CreateAccount/JE24AW_CreateAccount.jpg?impolicy=scale" />
        </ImageWrapper>
      </FormContainer>
    </Container>
  );
